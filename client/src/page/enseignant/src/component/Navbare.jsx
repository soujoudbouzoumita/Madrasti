            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem 1rem', backgroundColor: '#e3a9ee' }}>
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    {isUserDropdownOpen && (
                        ...
                        >
                            <li><Link to="/enseignant/profile" style={{ color: 'white', textDecoration: 'none' }}>Voir mon profil</Link></li>
                ...
                <ul style={{ display: 'flex', justifyContent: 'left', listStyle: 'none', gap: '1rem', margin: 10, paddingTop: '3px', paddingBottom: '10px', paddingLeft: '2px' }}>
                    ...
                    <li style={{ position: 'relative' }}>
                        ...
                        {isStudiesDropdownOpen && (
                            ...
                            >
                                <li><Link to="enseignant/emplois" style={{ color: 'white' }}>Emploi</Link></li>
                                <li><Link to="enseignant/mesreunions" style={{ color: 'white' }}>Mes reunions</Link></li>
                                <li><Link to="enseignant/Exams" style={{ color: 'white' }}>Exams</Link></li>
                                <li><Link to="enseignant/Cahierdetexte" style={{ color: 'white' }}>Cahierdetexte</Link></li>
                            </ul>
                        )}
                    </li>

                    <li>
                        <Link to="enseignant/contact" style={{ color: 'black' }}>contact</Link>
                    </li>
                </ul>
            </div>
        </nav>
