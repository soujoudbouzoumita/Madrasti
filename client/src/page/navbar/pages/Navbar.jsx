...
import { IoHome } from "react-icons/io5"; // Icon for Accueil
import { FiBookOpen } from "react-icons/fi"; // Icon for Mes études
import { BsChatDotsFill } from "react-icons/bs"; // Icon for Chat
import { FaCircleUser } from "react-icons/fa6"; // Icon for Utilisateur
import { MdArrowDropDown } from "react-icons/md"; // Dropdown arrow
...
const Navbar = ({ handleLogout, userType }) => {
  ...
  const renderMenuItems = () => {
    if (userType === "Administration") {
      ...
      return (
        <>
          <li><Link to="cahierdetexte">Cahier de texte</Link></li>
          <li><Link to="Exams">Examens</Link></li>
          <li><Link to="course">Cours</Link></li>
          <li><Link to="support">Support</Link></li>
          <li><Link to="reu">Réunions</Link></li>
          <li><Link to="notes">Notes</Link></li>
        </>
      );
    } else {
